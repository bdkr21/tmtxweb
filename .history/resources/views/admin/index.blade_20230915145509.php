  ...
  <body>
    ...
    <script>
      $(document).ready(function () {
        // Menampilkan detail data saat baris tabel di-hover
        $('tr[data-toggle="modal"]').hover(function () {
          var itemId = $(this).data('item-id');
          // Di sini Anda dapat memuat detail data menggunakan AJAX atau metode lain
          var detailData = ''; // Gantilah ini dengan data detail yang sebenarnya
      
          // Menampilkan detail data dalam modal
          $('#detailContent').html(detailData);
        });
      });
      </script>
