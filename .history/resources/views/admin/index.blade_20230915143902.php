  ...
  <body>
    ...
    <script>
      $(document).ready(function() {
          // Add a click event listener to each row with the "table-row" class
          $('.table-row').click(function() {
              ...
              $('#detailDob').text(dob);
              $('#detailArea').text(area);
  
              // Optionally, you can also set the title of the modal based on the clicked item's ID
              $('#detailModalLabel').text('Detail Data - ID: ' + itemId);
          });
      });
     </script>
