                        ...
                        <tbody>
                          ...
                          <tr id="tableRow-{{ $item->id }}">
                            ...
                            <td>
                              ...
                              <form action="{{ route('admin.ngeprint', $item->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                  PRINT
                                </button>
                              </form>
